...
// تسجيل دخول مشترك لوحدة أو مركز (حساب واحد مشترك باسم الوحدة/المركز
// وكلمة مرور واحدة، بدل بريد إلكتروني فردي لكل موظفة - يتحقق من شيت
// "الوحدات والمراكز"). يُنتج نفس شكل الجلسة (profile) تمامًا زي login()
// العادي، فتشتغل معه كل صفحات النظام الموجودة بدون أي تعديل إضافي.
